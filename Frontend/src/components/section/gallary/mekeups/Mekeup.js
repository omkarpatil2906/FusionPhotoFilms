...
import { MekeupImg } from "../../../services/ImagesServices";
...
function Mekeup() {
  const [mekeupImage, setMekeupImage] = useState([]);
  ...
  return (
    <div className="px-2 flex flex-col justify-centerpt-20 lg:pt-12 items-center bg-slate-50">
      ...
      {CommonHeading("Getting Ready Vibes")}
