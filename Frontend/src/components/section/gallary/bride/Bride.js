...
import { BrideImg } from "../../../services/ImagesServices";
...
function Bride() {
  ...
  return (
    <div className="px-2 flex flex-col justify-center pt-20 lg:pt-12 items-center bg-slate-50">
      ...
      {CommonHeading("Bride's Portraits")}
